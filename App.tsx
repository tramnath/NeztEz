...
export default function App() {
  ...
  const renderWalkthroughTab = () => {
    ...
    return (
      <ScrollView contentContainerStyle={[styles.contentContainer, { paddingBottom: bottomSafePadding }]}> 
        <View style={styles.hero}>
          <Text style={styles.heroTitle}>Walkthrough</Text>
          <Text style={styles.heroSubtitle}>
            {walkthrough.inspectionType} | {ratedItems}/{totalItems} items rated
          </Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.sectionTitle}>{walkthrough.propertyName}</Text>
          <Text style={styles.metaLine}>{walkthrough.propertyAddress || 'Address not set'}</Text>
          <Text style={styles.metaLine}>Tenant: {walkthrough.tenantName || 'Not specified'}</Text>
          ...
          <View style={styles.walkthroughActionsRow}>
            ...
            >
              ...
              <View style={styles.walkthroughCompleteCopy}>
                <Text style={styles.walkthroughCompleteTitle}>Complete walkthrough</Text>
                <Text style={styles.walkthroughCompleteMeta}>
                  Mark all spaces as done ({completedRooms}/{walkthrough.rooms.length} completed)
                </Text>
              </View>
            </TouchableOpacity>
          ...
          >
            {walkthrough.rooms.map((room) => (
              ...
              >
                ...
                <Text style={styles.swipeHint}>Swipe left or right to move between spaces.</Text>
